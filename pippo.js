...
for (let i = 0; i < nomi.length; i++) {
    const nameSingle = nomi[i].toLowerCase();  // trasforma tutti i nomi in minuscolo 
    const correctionName = nameSingle[0].toUpperCase() + nameSingle.slice(1);   //trasformo prima lettera del nome in maiuscolo e indico con slice il resto delle lettere della parola 
